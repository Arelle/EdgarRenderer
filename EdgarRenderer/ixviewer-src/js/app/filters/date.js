...
var FiltersDate = {
  ...
  dateQuarterEnd : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      ...
      var year = element.textContent.match(/\d{4}/)[0];
      var month;
      var day;
      
      var quarter = element.textContent.match(/1st|1|first|q1|2nd|2|second|q2|3rd|3|third|q3|4th|4|fourth|last|q4/gi);
  ...
  dateDayMonth : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      var result = moment(element.textContent, 'DDMM');
      if ( !result.isValid() ) {
  ...
  dateDayMonthYear : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      ...
      if ( result ) {
        ...
        var dateResult = moment(element.textContent, [
            'DD MM YY',
            'DD.MM.YYYY',
            'DD.MM.Y',
            'DD.MM.YY',
  ...
  datedaymonthyearinTR3 : function( element ) {
   if ( element && typeof element === 'object' && element['textContent'] ) {
      return FiltersDate.datedaymonthyearin(element.textContent, /^\s*([0-9\u0966-\u096F]{1,2})\s([\u0966-\u096F]{2}|[^\s0-9\u0966-\u096F]+)\s([0-9\u0966-\u096F]{2}|[0-9\u0966-\u096F]{4})\s*$/);
   }
  },

  datedaymonthyearinTR4 : function( element ) {
   if ( element && typeof element === 'object' && element['textContent'] ) {
      return FiltersDate.datedaymonthyearin(element.textContent, /^[ \t\n\r]*([0-9]{1,2}|[\u0966-\u096f]{1,2})[^0-9\u0966-\u096f]+(\u091c\u0928\u0935\u0930\u0940|\u092b\u0930\u0935\u0930\u0940|\u092e\u093e\u0930\u094d\u091a|\u0905\u092a\u094d\u0930\u0948\u0932|\u092e\u0908|\u091c\u0942\u0928|\u091c\u0941\u0932\u093e\u0908|\u0905\u0917\u0938\u094d\u0924|\u0938\u093f\u0924\u0902\u092c\u0930|\u0905\u0915\u094d\u091f\u0942\u092c\u0930|\u0928\u0935\u0902\u092c\u0930|\u0926\u093f\u0938\u0902\u092c\u0930)[^0-9\u0966-\u096f]+([0-9]{2}|[0-9]{4}|[\u0966-\u096f]{2}|[\u0966-\u096f]{4})[ \t\n\r]*$/);
   }
  },
  
  dateDotEU : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      var result = moment(element.textContent, 'DD.MM.Y');
      if ( !result.isValid() ) {
  ...
  dateDotUS : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      var result = moment(element.textContent, 'MM.DD.Y');
      if ( !result.isValid() ) {
  ...
  dateEraYearMonthDayJP : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      ...
      var result = regex.exec(FiltersNumber.jpDigitsToNormal(element.textContent));
  ...
  dateLongMonthYear : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      var result = moment(element.textContent, [ 'MMMM YY', 'MMMM YYYY' ], true);
      if ( !result.isValid() ) {
  ...
  dateLongUK : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      var result = moment(element.textContent, 'DD MMM YY');
      if ( !result.isValid() ) {
  ...
  dateLongUS : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      var result = moment(element.textContent, 'MMM DD, YY');
      if ( !result.isValid() ) {
  ...
  dateLongYearMonth : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      ...
      var result = moment(element.textContent, 'YY MMM');
      if ( !result.isValid() ) {
  ...
  dateMonthDay : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      ...
      var result = moment(element.textContent, 'MMDD');
      if ( !result.isValid() ) {
  ...
  dateShortDayMonthUK : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      var result = moment(element.textContent, 'DD MM');
      if ( !result.isValid() ) {
  ...
  dateShortMonthDayUS : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      var result = moment(element.textContent, 'MMM DD');
      if ( !result.isValid() ) {
  ...
  dateShortMonthYear : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      ...
      var result = moment(element.textContent, 'MMM YYYY');
      if ( !result.isValid() ) {
  ...
  dateShortUK : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      ...
      var result = moment(element.textContent, [ 'DD MMM YY', 'DD MMM YYYY' ]);
      if ( !result.isValid() ) {
  ...
  dateShortUS : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      ...
      var result = moment(element.textContent, [ 'MMM DD, YY', 'MMM DD, YYYY' ]);
      if ( !result.isValid() ) {
  ...
  dateShortYearMonth : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      ...
      var result = moment(element.textContent, [ 'YY MMM', 'YYYY MMM' ]);
      if ( !result.isValid() ) {
  ...
  dateSlashEU : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      ...
      var result = moment(element.textContent, [ 'DD/MM/YY', 'DD/MM/YYYY' ]);
      if ( !result.isValid() ) {
  ...
  dateSlashMonthDayUS : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      ...
      var result = moment(element.textContent, 'MM/DD');
      if ( !result.isValid() ) {
  ...
  dateSlashUS : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      ...
      var result = moment(element.textContent, [ 'MM/DD/YY', 'MM/DD/YYYY' ]);
      if ( !result.isValid() ) {
        return 'Format Error: Date Slash EU';
      }
      return result.format('YYYY-MM-DD');
  ...
  dateYearMonthDay : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      ...
      var fromJP = FiltersNumber.jpDigitsToNormal(element.textContent);
  ...
  datedaymonthbg : function( element ) {
   if ( element && typeof element === 'object' && element['textContent'] ) {
      return FiltersDate.datedaymonth(element.textContent, 
  ...
  datedaymonthyearTR4 : function( element ) {
   if ( element && typeof element === 'object' && element['textContent'] ) {
      return FiltersDate.datedaymonthyear(element.textContent, /^[ \t\n\r]*([0-9]{1,2})[^0-9]+([0-9]{1,2})[^0-9]+([0-9]{4}|[0-9]{1,2})[ \t\n\r]*$/, 1, 2, 3);
   }
  },
  ...
  datemonthyearroman : function( element ) {
   if ( element && typeof element === 'object' && element['textContent'] ) {
      return FiltersDate.datemonthyear(element.textContent, monthyearRomanPattern, ConstantsDate.monthnumberroman, 1, 6, 6);
   }
  },
 ...
 var empty = true;
  ...
  durYear : function( element ) {
    ...
    if ( element && typeof element === 'object' && element['textContent'] ) {
      ...
      var durationObj = ConstantsDate.getDuration(element.textContent);
...
return FiltersDate.printDurationType(null, null, null, hours, durationObj.negative);
  ...
  durWordsEn : function( element ) {
    if ( element && typeof element === 'object' && element['textContent'] ) {
      ...
      var result = regex.exec(element.textContent);
      if ( result && element.textContent.trim().length > 0 ) {
        var dur = 'P';
