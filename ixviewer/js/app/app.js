...
$(window)
    .load(
        function () {
          ...
          if (($.browser.msie && $.browser.versionNumber >= 10) || ($.browser.mozilla && $.browser.versionNumber >= 22)
...
function datedaymonthyeardk (arg) {
  ...
  if (m) {
    ...
    var _monEnd = m[3];
    var _monPer = m[4];
    if (_mon3 in monthnumber && ((!_monEnd && !_monPer) || (!_monEnd && _monPer) || (_monEnd && !_monPer))) {
...
function duryear (arg) {
  ...
  return printDurationType(years, null, null, null, n.sign);
}
...
function durmonth (arg) {
  ...
  return printDurationType(null, months, null, null, n.sign);
}
...
function datequarterend (arg) {
  ...
  if (arg.length > 0) {
    ...
    var _yr = arg.match(/\d{4}/)[0];
    var _mo;
    var _day;
    var q1 = arg.match(/1st|first|q1/gi);
    var q2 = arg.match(/2nd|second|q2/gi);
    var q3 = arg.match(/3rd|third|q3/gi);
    var q4 = arg.match(/4th|fourth|last|q4/gi);
...
var App_About = {
  ...
  additionalItems : function () {
    ...
    tbody.append($('<tr>').append(
        $('<th>').text('Total (Across all source documents)').attr('width', '70%').css('max-width', '260px').css('word-wrap', 'break-word')).append(
